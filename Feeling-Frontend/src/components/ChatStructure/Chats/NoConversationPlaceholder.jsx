...
const NoConversationPlaceholder = () => {
  return (
    <div className=" flex-col items-center justify-center h-full text-center p-6 hidden sm:flex">
      ...
      <p className="text-slate-400 max-w-md">
        Choose a contact from the sidebar to continue a chat once a user has messaged you.
      </p>
    </div>
  );
};
